...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prevmodules.forEach(function (item) {
      ...
      this.nextmodules.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
  ...
  _createClass(MiniSlider, [{
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoplay) {
          var activateTimer = function activateTimer() {
...
var Slider = function Slider() {
  ...
  this.prevmodules = document.querySelectorAll('.prev');
